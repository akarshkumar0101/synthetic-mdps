...
from util import save_pkl, load_pkl, calc_entropy_stable, tree_cat, tree_stack
...
group.add_argument("--n_augs_act", type=int, default=0)
group.add_argument("--p_same_act", type=float, default=0)
group.add_argument("--n_augs_time", type=int, default=0)
group.add_argument("--p_same_time", type=float, default=0)
...
group.add_argument("--n_iters_eval", type=int, default=500)
...
def construct_dataset(include_paths, exclude_paths, d_obs_uni, n_acts_uni):
...
def main(args):
    ...
    print(args.n_augs_obs, args.n_augs_act, args.n_augs_time)
    ...
    def loss_fn(agent_params, batch):
        ...
        # ce_hard = optax.softmax_cross_entropy_with_integer_labels(logits, batch['act'])
    ...
    def sample_train_batch(rng):
        ...
        batch = augment_batch(_rng_aug, batch,
                              ...
                              args.n_augs_act, args.p_same_act,
                              args.n_augs_time, args.p_same_time)
        return rng, batch

...
CUDA_VISIBLE_DEVICES=2 python icl_gen.py --env_id="random_function"                                                        --save_dir="../data/exp_icl//datasets//synthetic/random_function//"                                                        --n_seeds_seq=16 --n_seeds_par=16 --n_iters_train=100 --lr=0.0003 &
CUDA_VISIBLE_DEVICES=3 python icl_gen.py --env_id="zero_act"                                                               --save_dir="../data/exp_icl//datasets//synthetic/zero_act//"                                                               --n_seeds_seq=16 --n_seeds_par=16 --n_iters_train=100 --lr=0.0003 &
wait

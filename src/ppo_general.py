...
def make_train(config, env, network, callback=None, reset_env_iter=False, return_metric='rew', zero_rew=False):
    ...
    def train(md, rng, network_params):
        ...
        def _update_step(runner_state, _):
            ...
            def _env_step(runner_state, _):
                ...
                # SELECT ACTION
                rew_p_agent = jnp.zeros_like(rew_p) if zero_rew else rew_p
            ...
            return runner_state, (traj_batch['rew'].mean(axis=-1) if return_metric == 'rew' else None)
